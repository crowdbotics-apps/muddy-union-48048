"""
Django settings for muddy_union_48048 project.
...
ROOT_URLCONF = 'muddy_union_48048.urls'
...
WSGI_APPLICATION = 'muddy_union_48048.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_union_48048 API",
    "DESCRIPTION": "API documentation for muddy_union_48048 App",
    "VERSION": "v1",
}
